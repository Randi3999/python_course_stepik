...
day_num = int(input())
weight = float(input())
daily_weight_loss = (100 - 88) / 60
if 100 - weight >= daily_weight_loss * day_num:
    print("Все идет по плану")
else:
    print("Что-то пошло не так")
print(f"#{day_num} ДЕНЬ: ТЕКУЩИЙ ВЕС = {weight} кг, ЦЕЛЬ по ВЕСУ = {100 - daily_weight_loss * day_num} кг")
